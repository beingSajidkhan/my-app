    ...
    <>
      <section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <hr class="mt-16 mb-10 border-gray-600" />
          <p class="text-l text-center text-Black">&copy; Copyright 2023. All rights reserved:Design & Develop by <a href="https://biraventures.com/"> Bira Ventures Pvt. Ltd.</a></p>
