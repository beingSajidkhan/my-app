      ...
      <section class="py-4 bg-yellow-50 overflow-hidden">
        {/* <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8"> */}
          ...
          <div class="grid grid-cols-1 mt-8 text-center sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-4 ">
            <div class="md:p-8 lg:p-14" style={{borderRadius:"10"}}>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Waste Tax the owner of the landfill pays the tax and then passes
                the cost on to the public through fees for waste reception.
              </p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Water Tax a mandatory registration for starting a business, a
                tax levied by the municipal corporation, and a tax paid by water
                companies:
              </p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t addHover">
              <div style={{ display: "flex", justifyContent: "center" }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="46"
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Section 172(2)(h) gives powers to the municipal corporation to
                levy a tax on advertisement not being advertisements published
                in newspapers.
              </p>
            </div>
          </div>
